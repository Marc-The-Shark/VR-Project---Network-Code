...
{
	public class LocalLobbyServerList : MonoBehaviour
	{
		public LobbyManager lobbyManager;
		//public List<ServerResponse> serverList;
		...
		public void OnGUILocalMatchList(List<ServerResponse> matches)
		{
			StartCoroutine (WaitFor2Seconds ());
			Debug.Log(lobbyManager.discovery.serverList.Count);
			...
			for (int i = 0; i < matches.Count; ++i)
			{
				...
				o.GetComponent<LobbyServerEntry>().PopulateLocal(matches[i] , lobbyManager, (i % 2 == 0) ? OddServerColor : EvenServerColor);
		...
		public void RequestPage(int page)
		{
			...
			currentPage = page;
			OnGUILocalMatchList (lobbyManager.discovery.serverList);
